...
TRAIN_DATA = "tensorflow_exercises/lm/ptb.train"
EVAL_DATA = "tensorflow_exercises/lm/ptb.valid"
TEST_DATA = "tensorflow_exercises/lm/ptb.test"
HIDDEN_SIZE = 300
NUM_LAYERS = 2
VOCAB_SIZE = 10000
TRAIN_BATCH_SIZE = 20
...
class PTBModel(object):
    def __init__(self, is_training, batch_size, num_steps):
        ...
        inputs = tf.nn.embedding_lookup(embedding, self.input_data)  # inputs [batch_size, time, embedding_size]
