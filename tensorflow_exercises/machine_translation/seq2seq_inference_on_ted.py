...
@software: maimai
@file: seq2seq_inference_on_ted
@time: 2021/10/3 10:02 PM
@desc:
'''
import tensorflow as tf

from padded_batch_on_ted import SOS_ID, EOS_ID
from seq2seq_train_on_ted import HIDDEN_SIZE, NUM_LAYERS, SRC_VOCAB_SIZE, TRG_VOCAB_SIZE, SHARE_EMB_AND_SOFTMAX

CHECKPOINT_PATH = "tensorflow/iwlst_ted/seq2seq_ckpt/seq2seq_ckpt-0"
    ...
    def inference(self, src_input):
        ...
        with tf.variable_scope("decoder/rnn/multi_rnn_cell"):
            ...
            def continue_loop_condition(state, trg_ids, step):
                return tf.reduce_all(tf.logical_and(tf.not_equal(trg_ids.read(step), EOS_ID), tf.less(step, MAC_DEC_LEN - 1)))
